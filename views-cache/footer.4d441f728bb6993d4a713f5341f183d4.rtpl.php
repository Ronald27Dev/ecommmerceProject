<?php if(!class_exists('Rain\Tpl')){exit;}?>
  ...
  <div class="control-sidebtext/javascriptar-bg"></div>
</div>
<!-- ./wrapper -->
...
<script type="text/javascript">
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    function setActiveMenuItem(clickedItem){
      ...
      sidebarMenu.querySelectorAll("li").forEach(function(item) {
    ...
    if(activeHref){
      let activeLink = sidebarMenu.querySelector(`a[href="${activeHref}"]`);
      if(activeLink){
